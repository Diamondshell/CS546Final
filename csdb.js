...
async function main() {
    ...
    //Create Recipes
    let recipe = [];
    recipe.push({name:"Ketchup Fudge", description: "An abomination concocted by the vilest of human minds.", price: 1, cookTime: 25, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural", "Dessert"],steps: ["Lose all sense of self", "Make this", "Eat this"], userid: us[0]._id, imgpath: "./image/ketfudge.jpg"});
    recipe.push({name:"Turger", description: "A burger that is half burger, half turkey.", price: 6, cookTime: 70, appliances: ["Oven", "Grill"], popularity: 10, ingredients:["Turkey", "Ground Beef", "Cheese", "Tomato", "Lettuce", "BBQ Sauce"], tags:["Burger","Fun", "Independence Day"],steps: ["Cook Turkey", "Cook Beef", "Stack in Buns", "Burger is Made!"], userid: us[1]._id, imgpath: "./image/turger.jpeg"});
    ...
    recipe.push({name:"The Taste of Asgard", description: "A dish that brings to mind the longful reminitions of Asgard.", price: 5, cookTime: 30, appliances: ["Blender", "Microwave"], popularity: -10, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural", "Breakfast"],steps: ["Lose all sense of self", "Make this"], userid: us[3]._id, imgpath: "./image/asgard.png"});
    recipe.push({name:"Heavy Sauce", description: "A unique sauce with a density higher than lead.", price: 25, cookTime: 7, appliances: ["Blender", "Microwave"], popularity: 5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[0]._id, imgpath: "./image/heavysauce.jpg"});
    recipe.push({name:"Bacon Turducken", description: "A turkey, stuffed with duck, stuffed with chicken, covered with bacon.", price: 5, cookTime: 200, appliances: ["Blender", "Microwave"], popularity: 12, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural", "Breakfast"],steps: ["Lose all sense of self", "Make this"], userid: us[1]._id, imgpath: "./image/baconturducken.jpg"});
    recipe.push({name:"Chicken Fried Bacon", description: "Bacon fried like chicken.", price: 26, cookTime: 50, appliances: ["Blender", "Microwave"], popularity: 25, ingredients:["White Chocolate", "Ketchup", "Salt"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[2]._id, imgpath: "./image/chickenfriedbacon.jpg"});
    recipe.push({name:"Bacon Fried Chicken", description: "Chicken fried like bacon.", price: 2, cookTime: 40, appliances: ["Blender", "Microwave"], popularity: 30, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[3]._id, imgpath: "./image/baconfriedchicken.jpg"});
    recipe.push({name:"Fried Bacon Chicken", description: "Bacon covered chicken that's been fried.", price: 15, cookTime: 50, appliances: ["Blender", "Microwave"], popularity: 24, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[0]._id, imgpath: "./image/friedbaconchicken.jpg"});
    recipe.push({name:"Fried Chicken Bacon", description: "Chicken covered bacon that's been fried.", price: 8, cookTime: 40, appliances: ["Blender", "Microwave"], popularity: 12, ingredients:["Butter", "Chicken", "Milk", "Bacon"], tags:["What","Unnatural", "Dinner"],steps: ["Lose all sense of self", "Make this"], userid: us[1]._id, imgpath: "./image/chickenfriedbacon.jpg"});
    recipe.push({name:"Foolish Mortal Juice", description: "A juice frequently consumed by foolish mortals.", price: 124, cookTime: 42048000, appliances: ["Blender", "Microwave"], popularity: 12, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[2]._id, imgpath: "./image/foolishmortal.jpg"});
    recipe.push({name:"The One Ring", description: "A ring that grants one the nebulous power of being invisible kinda.", price: 133, cookTime: 180, appliances: ["Mount Doom","Forge"], popularity: 11, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[3]._id, imgpath: "./image/theonering.png"});
    recipe.push({name:"Sauteed Hobbit", description: "A hobbit that is sauteeing various foods.", price: 526, cookTime: 267840, appliances: ["Blender", "Microwave"], popularity: 3, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[0]._id, imgpath: "./image/sauteedhobbit.jpg"});
    recipe.push({name:"The Angry Trooper", description: "A trooper that is angry, and who made a cool dish.", price: 22, cookTime: 20, appliances: ["Blender", "Microwave"], popularity: 546, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[1]._id, imgpath: "./image/angrytrooper.jpg"});
    recipe.push({name:"Nostalgia in a Bottle", description: "A drink that brings to mind happiness and old memories, with just a tinge of regret.", price: 8, cookTime: 2628000, appliances: ["Blender", "Microwave"], popularity: 125, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[2]._id, imgpath: "./image/nostalgia.jpg"});
    recipe.push({name:"Pie That I Like", description: "It's a pie that I like.", price: 31, cookTime: 592, appliances: ["Blender", "Microwave"], popularity: -20, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[3]._id, imgpath: "./image/pie.jpg"});
    recipe.push({name:"Grandma Perry's Old Fashioned Vodka", description: "A vodka my grandma used to make.", price: 1, cookTime: 120, appliances: ["Still", "Tubing", "Fire Pit"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[0]._id, imgpath: "./image/vodka.jpg"});
    recipe.push({name:"Unusual Chicken Sauce", description: "A sauce that is quite unusual, typically served over chicken.", price: 12, cookTime: 30, appliances: ["Blender", "Microwave"], popularity: 56, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[1]._id, imgpath: "./image/unusualsauce.jpg"});
    recipe.push({name:"Sour Dwarf Ale", description: "An ale made out of sour dwarf cherries.", price: 2, cookTime: 128, appliances: ["Blender", "Microwave"], popularity: 10, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[2]._id, imgpath: "./image/sourdwarf.jpg"});
    recipe.push({name:"The Empire Supreme", description: "A meal that makes one want to go listen to Imperial March.", price: 24, cookTime: 54, appliances: ["Oven"], popularity: 100, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[3]._id, imgpath: "./image/empire.jpg"});
