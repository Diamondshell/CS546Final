...
var CreateRecipeModalComponent = (function () {
    ...
    CreateRecipeModalComponent.prototype.submit = function () {
        ...
        for (var i = 0; i < this.recipe.appliances.length; i++) {
...
var DataService = (function () {
    ...
    DataService.prototype.getRandomRecipe = function (filter) {
        var _this = this;
...
module.exports = "<div id=\"randomRecipeModalWrapper\">\n  <form>\n    <h2 mat-dialog-title id=\"RandomLabel\">Random Recipe</h2>\n    <h3 mat-dialog-title a>*Choose any or none*</h3>\n      <ul> \n          <li *ngFor=\"let f of filters\" class = \"filter-group\">\n            <h3>{{f.section_text}}</h3>\n            <ul>\n                <li *ngFor=\"let fi of f.values\" class = \"filters\">\n                  <input type=\"checkbox\" id={{fi.name}} name={{fi.name}} (click)=\"onDoCheck($event, fi, f)\">\n                  <label for={{fi.name}}>{{fi.text}}</label>\n                </li>\n            </ul>\n          </li>\n        </ul>\n      <button mat-raised-button class=\"submit\" (click)=\"getRandom()\"  value=\"submit\">Randomize!</button>\n  </form>\n</div>"
...
var RandomRecipeModalComponent = (function () {
    function RandomRecipeModalComponent(router, dialogRef, dataService) {
        this.router = router;
        this.dialogRef = dialogRef;
        this.dataService = dataService;
        this.filters = [
    ...
    RandomRecipeModalComponent.prototype.onDoCheck = function (e, fi, f) {
        if (e.target.checked) {
            if (f.section_name == "mealType" || f.section_name == "mealStyle")
                this.tags.push(fi.name);
            if (f.section_name == "rating")
    ...
    RandomRecipeModalComponent.prototype.getRandom = function () {
        var _this = this;
        var filter = {};
        if (this.tags.length)
            filter.tags = this.tags;
        ...
        this.dataService.getRandomRecipe({ filter: filter })
            .subscribe(function (i) { return _this.router.navigate(['./recipe/' + i._id]); });
        this.dialogRef.close('');
    };
    ...
    RandomRecipeModalComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_1__angular_material__["g" /* MatDialogRef */], __WEBPACK_IMPORTED_MODULE_3__data_service__["a" /* DataService */]])
...
module.exports = "<div id=\"register\">\n  <form ngNoForm>\n    <mat-form-field>\n      <input matInput required=\"required\" placeholder=\"Username\" pattern=\"[^'\\x22><]+\" title=\"Username: No Special Characters\">\n    </mat-form-field>\n    <p>\n      <mat-form-field>\n        <input matInput required=\"required\" type=\"email\" placeholder=\"Email Address\"  title=\"Email\">\n      </mat-form-field>\n    </p>\n    <p>\n      <mat-form-field class=\"demo-full-width\">\n        <input matInput required=\"required\" type=\"password\" placeholder=\"Password\" pattern=\"[^'\\x22><]+\" title=\"Password: No < '  >\">\n      </mat-form-field>\n      <mat-form-field class=\"password\">\n        <input matInput required=\"required\" type=\"password\" placeholder=\"Confirm Password\" pattern=\"[^'\\x22><]+\" title=\"Password: No < '  >\">\n      </mat-form-field>\n    </p>\n    <button mat-raised-button class=\"submit\" type=\"submit\" value=\"Register!\">Register!</button>\n  </form>\n</div>"
