...
async function main() {
    ...
    recipe.push({name:"Sacriligious Goo", price: 15, cookTime: 240, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[2]._id, imgpath: "./image/a"});
    recipe.push({name:"The Taste of Asgard", price: 2.54, cookTime: 30, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[3]._id, imgpath: "./image/a"});
    ...
    recipe.push({name:"Bacon Turducken", price: 5.46, cookTime: 200, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[1]._id, imgpath: "./image/a"});
    recipe.push({name:"Chicken Fried Bacon", price: 8.6, cookTime: 50, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[2]._id, imgpath: "./image/a"});
    recipe.push({name:"Bacon Fried Chicken", price: 8.2, cookTime: 40, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[3]._id, imgpath: "./image/a"});
    recipe.push({name:"Fried Bacon Chicken", price: 8.6, cookTime: 50, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[0]._id, imgpath: "./image/a"});
    recipe.push({name:"Fried Chicken Bacon", price: 8.2, cookTime: 40, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[1]._id, imgpath: "./image/a"});
    recipe.push({name:"Foolish Mortal Juice", price: 1234, cookTime: 42048000, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[2]._id, imgpath: "./image/a"});
    recipe.push({name:"The One Ring", price: 1337.34, cookTime: 180, appliances: ["Mount Doom","Forge"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[3]._id, imgpath: "./image/a"});
    recipe.push({name:"Sauteed Hobbit", price: 526.12, cookTime: 267840, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[0]._id, imgpath: "./image/a"});
    recipe.push({name:"The Angry Trooper", price: 21.87, cookTime: 20, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[1]._id, imgpath: "./image/a"});
    recipe.push({name:"Nostalgia in a Bottle", price: 8.77, cookTime: 2628000, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[2]._id, imgpath: "./image/a"});
    recipe.push({name:"Pie That I Like", price: 31.41, cookTime: 592, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[3]._id, imgpath: "./image/a"});
    ...
    recipe.push({name:"Unusual Chicken Sauce", price: 12.23, cookTime: 30, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[1]._id, imgpath: "./image/a"});
    recipe.push({name:"Sour Dwarf Ale", price: 2.56, cookTime: 128, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[2]._id, imgpath: "./image/a"});
    recipe.push({name:"The Empire Supreme", price: 24.56, cookTime: 54, appliances: ["Blender", "Microwave"], popularity: -5, ingredients:["White Chocolate", "Ketchup", "Maple Syrup"], tags:["What","Unnatural"],steps: ["Lose all sense of self", "Make this"], userid: us[3]._id, imgpath: "./image/a"});
